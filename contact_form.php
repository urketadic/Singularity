...
$mail->Username = 'urostadic2@gmail.com';             // SMTP username
$mail->Password = 'Sveromuboga';                           // SMTP password
$mail->SMTPSecure = 'tls';
$mail->Port = 587;                                    // TCP port to connect to
// Add the address to send the mail to
$mail->AddAddress('applications@gamingforgood.net');
$mail->WordWrap = 50;                                 // Set word wrap to 50 characters
$mail->IsHTML(true);                                  // Set email format to HTML

// add your company name here
$company_name = 'Singularity Group';
...
$success_message->message   = 'Thank you! Your application has been sent';
...
$mail_error_message->message   = 'Error! Your mail was not sent. Try again.';
